    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="flex items-start justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-serif" style={{ color: 'var(--text)', fontWeight: 500 }}>Stories</h1>
      ...
      {stories.length === 0 ? (
        <div className="text-center py-20">
          ...
          <p className="text-base mb-4" style={{ color: 'var(--muted)' }}>No stories yet. Be the first to plant one.</p>
          {canWrite && (
              ...
              <Link href={`/stories/${story.id}`} className="block group py-6">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2
                      className="text-xl font-serif mb-2 leading-snug transition-colors"
